...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        是否归还
                                        <div class="layui-input-inline">
                                            <select name="shebeiJieyongTypesSelectSearch"  style="width: 150px;" id="shebeiJieyongTypesSelectSearch" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        设备状态
                                        <div class="layui-input-inline">
                                            <select name="shebeiZhuangtaiTypesSelectSearch"  style="width: 150px;" id="shebeiZhuangtaiTypesSelectSearch" class="form-control form-control-sm"
                                                    aria-controls="tableId">
                                            </select>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        var shebeiZhuangtaiTypesOptions = [];

        <!-- 本表的级联字段表 -->
        var shebeiJieyongTypesOptions = [];
        ...
        <!-- 级联表的级联字典表 -->
            ...
            var shebeiZhuangtaiTypesSelectSearchInput = document.getElementById("shebeiZhuangtaiTypesSelectSearch");
            if(shebeiZhuangtaiTypesSelectSearchInput != null){
                var shebeiZhuangtaiTypesIndex = shebeiZhuangtaiTypesSelectSearchInput.selectedIndex;
                if( shebeiZhuangtaiTypesIndex  != 0){
                    searchForm.shebeiZhuangtaiTypes = document.getElementById("shebeiZhuangtaiTypesSelectSearch").options[shebeiZhuangtaiTypesIndex].value;
                }
            }
            ...
            if(shebeiJieyongNumberEndSearchInput != null){
                ...
                //是否归还
            var shebeiJieyongTypesSelectSearchInput = document.getElementById("shebeiJieyongTypesSelectSearch");
            if(shebeiJieyongTypesSelectSearchInput != null){
                var shebeiJieyongTypesIndex = shebeiJieyongTypesSelectSearchInput.selectedIndex;
                if( shebeiJieyongTypesIndex  != 0){
                    searchForm.shebeiJieyongTypes= document.getElementById("shebeiJieyongTypesSelectSearch").options[shebeiJieyongTypesIndex].value;
                }
            }
                    getDataList();
        }
        ...
        function getDataList() {
            http("shebeiJieyong/page", "GET", {
                ...
                shebeiJieyongTypes: searchForm.shebeiJieyongTypes,
            //级联表的
                shebeiName: searchForm.shebeiName,
                shebeiTypes: searchForm.shebeiTypes,
                shebeiZhuangtaiTypes: searchForm.shebeiZhuangtaiTypes,
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(shebeiContentCell);
                        ...
                        //设备状态
            var shebeiZhuangtaiTypesCell = document.createElement('td');
            shebeiZhuangtaiTypesCell.innerHTML = item.shebeiZhuangtaiValue;
            row.appendChild(shebeiZhuangtaiTypesCell);
            ...
            row.appendChild(shebeiJieyongNumberCell);
                ...
                //备注
            var beizhuContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.beizhuContent && item.beizhuContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.beizhuContent.indexOf('<img');
                var endIndex = item.beizhuContent.indexOf('>');
                    beizhuContentCell.innerHTML = item.beizhuContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.beizhuContent != null && item.beizhuContent != "" && item.beizhuContent.length >= 11) {
                        beizhuContentCell.innerHTML = item.beizhuContent.substring(0, 10) + "...";
                } else {
                        beizhuContentCell.innerHTML = item.beizhuContent;
                }
            }
            row.appendChild(beizhuContentCell);


            //是否归还
            var shebeiJieyongTypesCell = document.createElement('td');
            shebeiJieyongTypesCell.innerHTML = item.shebeiJieyongValue;
            row.appendChild(shebeiJieyongTypesCell);
    ...
    //填充级联表搜索下拉框
        ...
        function shebeiZhuangtaiTypesSelectSearch() {
            var shebeiZhuangtaiTypesSelectSearch = document.getElementById('shebeiZhuangtaiTypesSelectSearch');
            if(shebeiZhuangtaiTypesSelectSearch != null) {
                shebeiZhuangtaiTypesSelectSearch.add(new Option('-请选择-',''));
                if (shebeiZhuangtaiTypesOptions != null && shebeiZhuangtaiTypesOptions.length > 0){
                    for (var i = 0; i < shebeiZhuangtaiTypesOptions.length; i++) {
                            shebeiZhuangtaiTypesSelectSearch.add(new Option(shebeiZhuangtaiTypesOptions[i].indexName, shebeiZhuangtaiTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //填充本表搜索下拉框
        ...
        function shebeiJieyongTypesSelectSearch() {
            var shebeiJieyongTypesSelectSearch = document.getElementById('shebeiJieyongTypesSelectSearch');
            if(shebeiJieyongTypesSelectSearch != null) {
                shebeiJieyongTypesSelectSearch.add(new Option('-请选择-',''));
                if (shebeiJieyongTypesOptions != null && shebeiJieyongTypesOptions.length > 0){
                    for (var i = 0; i < shebeiJieyongTypesOptions.length; i++) {
                            shebeiJieyongTypesSelectSearch.add(new Option(shebeiJieyongTypesOptions[i].indexName,shebeiJieyongTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询级联表搜索条件所有列表
            ...
            function shebeiZhuangtaiTypesSelect() {
                //填充下拉框选项
                http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=shebei_zhuangtai_types", "GET", {}, (res) => {
                    if(res.code == 0){
                        shebeiZhuangtaiTypesOptions = res.data.list;
                    }
                });
            }

    //查询当前表搜索条件所有列表
            function shebeiJieyongTypesSelect() {
                //填充下拉框选项
                http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=shebei_jieyong_types", "GET", {}, (res) => {
                    if(res.code == 0){
                        shebeiJieyongTypesOptions = res.data.list;
                    }
                });
            }
        ...
        $(document).ready(function () {
            ...
            //查询级联表的搜索下拉框
            shebeiTypesSelect();
            shebeiZhuangtaiTypesSelect();

            //查询当前表的搜索下拉框
            shebeiJieyongTypesSelect();
            getDataList();
        ...
        //级联表的下拉框赋值
            ...
            shebeiZhuangtaiTypesSelectSearch();
        ...
        //当前表的下拉框赋值
            ...
            shebeiJieyongTypesSelectSearch();
