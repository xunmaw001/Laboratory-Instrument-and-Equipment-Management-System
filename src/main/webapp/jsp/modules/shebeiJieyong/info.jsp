            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">设备借用登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="shebeiZhuangtaiValue" name="shebeiZhuangtaiValue" class="form-control"
                                               v-model="ruleForm.shebeiZhuangtaiValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="shebeiId" name="shebeiId" v-model="ruleForm.shebeiId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="shebeiJieyongNumber" name="shebeiJieyongNumber" class="form-control"
                                               v-model="ruleForm.shebeiJieyongNumber" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>是否归还</label>
                                    <input id="shebeiJieyongValue" name="shebeiJieyongValue" class="form-control"
                                           v-model="ruleForm.shebeiJieyongValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "shebeiJieyong/info/" + id,
        ...
        if (ruleForm.beizhuContent != null && ruleForm.beizhuContent != 'null' && ruleForm.beizhuContent != '') {
            var beizhuContentUeditor = UE.getEditor('beizhuContentEditor');
                beizhuContentUeditor.ready(function () {
                    ...
                    beizhuContentUeditor.setDisabled('fullscreen');
            });
        }
    }
