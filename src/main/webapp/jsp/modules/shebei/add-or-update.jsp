                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>设备状态</label>
                                        <select id="shebeiZhuangtaiTypesSelect" name="shebeiZhuangtaiTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationShebeizhuangtaitypesSelect(){
            var shebeiZhuangtaiTypesSelect = document.getElementById('shebeiZhuangtaiTypesSelect');
            if(shebeiZhuangtaiTypesSelect != null && shebeiZhuangtaiTypesOptions != null  && shebeiZhuangtaiTypesOptions.length > 0 ){
                for (var i = 0; i < shebeiZhuangtaiTypesOptions.length; i++) {
                    shebeiZhuangtaiTypesSelect.add(new Option(shebeiZhuangtaiTypesOptions[i].indexName,shebeiZhuangtaiTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(shebeiZhuangtaiTypesSelect != null && shebeiZhuangtaiTypesOptions != null  && shebeiZhuangtaiTypesOptions.length > 0 ) {
            for (var i = 0; i < shebeiZhuangtaiTypesOptions.length; i++) {
                if (shebeiZhuangtaiTypesOptions[i].codeIndex == ruleForm.shebeiZhuangtaiTypes) {//下拉框value对比,如果一致就赋值汉字
                        shebeiZhuangtaiTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationShebeizhuangtaitypesSelect();
            <!--  初始化级联表的下拉框  -->
