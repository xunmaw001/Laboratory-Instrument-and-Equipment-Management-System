            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">实验室预约登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="shiyanshiName" name="shiyanshiName" class="form-control"
                                                   v-model="ruleForm.shiyanshiName" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="shiyanshiValue" name="shiyanshiValue" class="form-control"
                                               v-model="ruleForm.shiyanshiValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="shiyanshiId" name="shiyanshiId" v-model="ruleForm.shiyanshiId" readonly type="hidden">

                                    <div class="form-group col-md-6">
                                        <label>预约时间</label>
                                        <input id="yuyueTime" name="yuyueTime" class="form-control"
                                               v-model="ruleForm.yuyueTime" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="shiyanshiYuyueNumber" name="shiyanshiYuyueNumber" class="form-control"
                                               v-model="ruleForm.shiyanshiYuyueNumber" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>是否同意</label>
                                    <input id="shiyanshiYuyueValue" name="shiyanshiYuyueValue" class="form-control"
                                           v-model="ruleForm.shiyanshiYuyueValue" readonly>
                                </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "shiyanshiYuyue/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.shiyanshiContent != null && ruleForm.shiyanshiContent != 'null' && ruleForm.shiyanshiContent != '') {
            var shiyanshiContentUeditor = UE.getEditor('shiyanshiContentEditor');
                shiyanshiContentUeditor.ready(function () {
                    ...
                    shiyanshiContentUeditor.setDisabled('fullscreen');
            });
        }
